...
namespace SpecFlowBDDAutomationFramework.Hooks
{
    ...
    public sealed class Hooks :ExtentReport 
    {
        ...
        public void BeforeScenarioWithTag(ScenarioContext scenarioContext)
        {
            ...
            driver.Navigate().GoToUrl(login.webpage);
            //  Helper.help.getElementByName("username").Clear();
            help.getElementByName(login.username_element).SendKeys(login.username);
            help.getElementByName(login.memdata_element).SendKeys(login.memdata);
            help.getElementByName(login.password_element).SendKeys(login.password);
            help.GetElementByXPath(login.login_XPath).Click();
